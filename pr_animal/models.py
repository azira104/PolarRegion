...
class adeliePenguin(models.Model):
    ...
    date_pair_count = models.DateField(null=True, blank=True)
    total_number_pairs_with_eggs = models.IntegerField(null=True, blank=True)
    total_number_of_pairs_without_eggs = models.IntegerField(null=True, blank=True)
    total_number_of_pairs = models.IntegerField(null=True, blank=True)
    date_chick_count = models.DateField(null=True, blank=True)
    total_number_of_chicks = models.IntegerField(null=True, blank=True)
    total_number_of_eggs = models.IntegerField(null=True, blank=True)
    total_number_of_nests_without_eggs = models.IntegerField(null=True, blank=True)
    date_fledgling_count = models.DateField(null=True, blank=True)
    total_number_of_fledglings = models.IntegerField(null=True, blank=True)
